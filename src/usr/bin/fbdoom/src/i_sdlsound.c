...
static boolean setpanning_workaround = _false;

static boolean sound_initialized = _false;
...
// and free a sound that is not in use, to free up memory.  Return _true
// for success.
