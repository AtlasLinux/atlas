...
typedef struct
{
    int 	istexture;	// if _false, it is a flat
    char	endname[9];
    char	startname[9];
    int		speed;
} animdef_t;
...
animdef_t		animdefs[] =
{
    {_false,	"NUKAGE3",	"NUKAGE1",	8},
    {_false,	"FWATER4",	"FWATER1",	8},
    {_false,	"SWATER4",	"SWATER1", 	8},
    {_false,	"LAVA4",	"LAVA1",	8},
    {_false,	"BLOOD3",	"BLOOD1",	8},

    // DOOM II flat animations.
    {_false,	"RROCK08",	"RROCK05",	8},		
    {_false,	"SLIME04",	"SLIME01",	8},
    {_false,	"SLIME08",	"SLIME05",	8},
    {_false,	"SLIME12",	"SLIME09",	8},

    {_true,	"BLODGR4",	"BLODGR1",	8},
    {_true,	"SLADRIP3",	"SLADRIP1",	8},

    {_true,	"BLODRIP4",	"BLODRIP1",	8},
    {_true,	"FIREWALL",	"FIREWALA",	8},
    {_true,	"GSTFONT3",	"GSTFONT1",	8},
    {_true,	"FIRELAVA",	"FIRELAV3",	8},
    {_true,	"FIREMAG3",	"FIREMAG1",	8},
    {_true,	"FIREBLU2",	"FIREBLU1",	8},
    {_true,	"ROCKRED3",	"ROCKRED1",	8},

    {_true,	"BFALL4",	"BFALL1",	8},
    {_true,	"SFALL4",	"SFALL1",	8},
    {_true,	"WFALL4",	"WFALL1",	8},
    {_true,	"DBRAIN4",	"DBRAIN1",	8},
