...
ST_Responder (event_t* ev)
{
  ...
  else if (ev->type == ev_keydown)
  {
	...
	plyr->message = DEH_String(STSTR_BEHOLD);
      ...
      {
	plyr->weaponowned[wp_chainsaw] = _true;
	plyr->powers[pw_invulnerability] = _true;
...
void ST_initData(void)
{
    ...
    st_statusbaron = _true;
    st_oldchat = st_chat = _false;
    st_cursoron = _false;
...
static boolean	st_stopped = _true;
